  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col h-full bg-secondary/30">
          ...
          <div className="flex items-center gap-2 px-4 py-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="default" className="rounded-full bg-gray-900 hover:bg-gray-800">
                  AI Toolkit examples
        ...
        {/* Main Editor Area */}
        <div className="flex-1 overflow-y-auto py-8 bg-secondary/20">
          <div className="max-w-[850px] mx-auto px-8 relative">
            {/* Document Page */}
            <div
              className="bg-card rounded-lg shadow-sm border border-border p-16 min-h-[1056px] relative"
